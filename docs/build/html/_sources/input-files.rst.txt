...
|                 | models.         |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| NetRadiationMet | R               | Determines      |                 |
| hod             |                 | method for      |                 |
| (previously     |                 | calculation of  |                 |
| NetRadiationCho |                 | radiation       |                 |
| ice)            |                 | fluxes.         |                 |
+-----------------+-----------------+-----------------+-----------------+
| Value           | Comments        |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
...
|                 | provided.       |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| StorageHeatMeth |                 | Determines      |                 |
| od              |                 | method for      |                 |
| (previously     |                 | calculating     |                 |
| QSChoice)       |                 | storage heat    |                 |
|                 |                 | flux ΔQS.       |                 |
+-----------------+-----------------+-----------------+-----------------+
| Value           | Comments        |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
...
|                 | using Q*+QF.    |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| StabilityMethod | R               | Defines which   |                 |
|                 |                 | atmospheric     |                 |
|                 |                 | stability       |                 |
|                 |                 | functions are   |                 |
|                 |                 | used.           |                 |
...
|                 | (1988) [84]_    |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| RoughLenHeatMet | R               | Determines      |                 |
| hod             |                 | method for      |                 |
| (previously     |                 | calculating     |                 |
| RoughLen_heat)  |                 | roughness       |                 |
|                 |                 | length for      |                 |
|                 |                 | heat.           |                 |
+-----------------+-----------------+-----------------+-----------------+
| Value           | Comments        |                 |                 |
...
|                 | .               |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| RoughLenMomMeth | R               | Determines how  |                 |
| od              |                 | aerodynamic     |                 |
| (previously     |                 | roughness       |                 |
| z0_method)      |                 | length (z0m)    |                 |
|                 |                 | and zero        |                 |
|                 |                 | displacement    |                 |
|                 |                 | height (zdm)    |                 |
|                 |                 | are calculated. |                 |
...
| Value           | Comments        |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| 1               | \*Values        | SUEWS_SiteSelec |                 |
|                 | specified in    | t.txt]]         |                 |
|                 | [[#SUEWS_SiteSe | are used. Note  |                 |
|                 | lect.txt        | that            |                 |
|                 |                 | `UMEP <http://u |                 |
|                 |                 | rban-climate.ne |                 |
|                 |                 | t/umep/UMEP>`__ |                 |
...
|                 |                 | 016             |                 |
+-----------------+-----------------+-----------------+-----------------+
| 2               | \*z0m and zd    | SUEWS_SiteSelec |                 |
|                 | are calculated  | t.txt]].        |                 |
|                 | using 'rule of  | -  z0m and zd   |                 |
|                 | thumb'          | are adjusted    |                 |
|                 | (Grimmond and   | with time to    |                 |
|                 | Oke 1999 [88]_) | account for     |                 |
|                 | using mean      | seasonal        |                 |
|                 | building and    | variation in    |                 |
|                 | tree height     | porosity of     |                 |
|                 | specified in    | deciduous       |                 |
|                 | [[#SUEWS_SiteSe | trees.          |                 |
|                 | lect.txt        |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| 3               | \*z0m and zd    | SUEWS_SiteSelec |                 |
|                 | are calculated  | t.txt]].        |                 |
|                 | based on the    | -  z0m and zd   |                 |
|                 | MacDonald et    | are adjusted    |                 |
|                 | al.             | with time to    |                 |
|                 | (1998) [89]_    | account for     |                 |
|                 | method using    | seasonal        |                 |
|                 | mean building   | variation in    |                 |
|                 | and tree        | porosity of     |                 |
|                 | heights, plan   | deciduous       |                 |
|                 | area fraction   | trees.          |                 |
|                 | and frontal     |                 |                 |
|                 | areal index     |                 |                 |
|                 | specified in    |                 |                 |
...
|                 | lect.txt        |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| SMDMethod       | R               | Determines      |                 |
| (previously     |                 | method for      |                 |
| SMD_Choice)     |                 | calculating     |                 |
|                 |                 | soil moisture   |                 |
|                 |                 | deficit (SMD).  |                 |
+-----------------+-----------------+-----------------+-----------------+
| Value           | Comments        |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| 0               | -  **Recommende | SUEWS_Soil.txt] |                 |
|                 | d**             | ].              |                 |
|                 | \*SMD modelled  |                 |                 |
|                 | using           |                 |                 |
|                 | parameters      |                 |                 |
...
|                 | xt              |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| 1               | \*'''Not        | '''             | SUEWS_Soil.txt] |
|                 | currently       | -  Observed SM  | ].              |
|                 | implemented -   | provided in     |                 |
|                 | do not use      | the             |                 |
|                 |                 | meteorologic    |                 |
|                 |                 | al              |                 |
|                 |                 | forcing file    |                 |
...
|                 |                 | xt              |                 |
+-----------------+-----------------+-----------------+-----------------+
| WaterUseMethod  | R               | Defines how     |                 |
| (previously     |                 | external water  |                 |
| WUChoice)       |                 | use is          |                 |
|                 |                 | calculated.     |                 |
+-----------------+-----------------+-----------------+-----------------+
| Value           | Comments        |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| 0               | External water  | SUEWS_Irrigatio |                 |
|                 | use modelled    | n.txt]].        |                 |
|                 | using           |                 |                 |
|                 | parameters      |                 |                 |
|                 | specified in    |                 |                 |
...
| options*        |                 |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| FileCode        | R               | Two-letter site |                 |
|                 |                 | identification  |                 |
|                 |                 | code (e.g. He,  |                 |
|                 |                 | Sc, Kc).        |                 |
+-----------------+-----------------+-----------------+-----------------+
| FileInputPath   | R               | Input           |                 |
|                 |                 | directory.      |                 |
+-----------------+-----------------+-----------------+-----------------+
| FileOutputPath  | R               | Output          |                 |
|                 |                 | directory.      |                 |
+-----------------+-----------------+-----------------+-----------------+
| MultipleMetFile | R               | Specifies       |                 |
| s               |                 | whether one     |                 |
|                 |                 | single          |                 |
|                 |                 | meteorological  |                 |
|                 |                 | forcing file is |                 |
...
|                 | out.            |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| WriteOutOption  | O               | Specifies which |                 |
|                 |                 | variables are   |                 |
|                 |                 | written in the  |                 |
|                 |                 | output files.   |                 |
+-----------------+-----------------+-----------------+-----------------+
...
|                 |                 | s).             |                 |
+-----------------+-----------------+-----------------+-----------------+
| ResolutionFiles | R               | Specifies the   |                 |
| In              |                 | resolution of   |                 |
|                 |                 | the input files |                 |
|                 |                 | [s] which SUEWS |                 |
|                 |                 | will            |                 |
...
|                 |                 | = Tstep.)       |                 |
+-----------------+-----------------+-----------------+-----------------+
| ResolutionFiles | O               | Specifies the   |                 |
| InESTM          |                 | resolution of   |                 |
|                 |                 | the ESTM input  |                 |
|                 |                 | files [s] which |                 |
|                 |                 | SUEWS will      |                 |
|                 |                 | disaggregate to |                 |
...
|                 | default option. |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| RainDisaggMetho | O               | Specifies how   |                 |
| d               |                 | rain in the     |                 |
|                 |                 | meteorological  |                 |
|                 |                 | forcing file    |                 |
|                 |                 | are             |                 |
...
|                 |                 | = 101.          |                 |
+-----------------+-----------------+-----------------+-----------------+
| MultRainAmongN  | O               | Specifies the   |                 |
|                 |                 | number of       |                 |
|                 |                 | subintervals    |                 |
|                 |                 | (of length tt)  |                 |
|                 |                 | over which to   |                 |
...
|                 |                 | = 12            |                 |
+-----------------+-----------------+-----------------+-----------------+
| MultRainAmongNU | O               | Specifies upper |                 |
| pperI           |                 | limit for each  |                 |
|                 |                 | intensity bin   |                 |
|                 |                 | to apply        |                 |
|                 |                 | MultRainAmongN. |                 |
|                 |                 | Any intensities |                 |
...
|                 |                 | = 50.0          |                 |
+-----------------+-----------------+-----------------+-----------------+
| DisaggMethodEST | O               | Specifies how   |                 |
| M               |                 | ESTM-related    |                 |
|                 |                 | temperatures in |                 |
|                 |                 | the input file  |                 |
|                 |                 | are             |                 |
...
area. These text files are stored as worksheets in
...
.. figure:: GridConnections_2_v2.jpg
   :alt:  Example values for the grid connections part of SUEWS_SiteSelect.txt for the grids.|none
	...
	Example values for the grid connections part of
   `SUEWS_SiteSelect.txt <#SUEWS_SiteSelect.txt>`__ for the grids.|none
...
|     |     |         |         | ace**   |         |         |   |
+-----+-----+---------+---------+---------+---------+---------+---+
| 9   | MD  | Drainag | 1, 2, 3 | Drainag | O       | F       |   |
|     |     | eEq     |         | e       | p       | a       |   |
|     |     |         |         | equatio | t       | l       |   |
|     |     |         |         | n       | i       | k       |   |
|     |     |         |         | to use  | o       | a       |   |
...
|     |     |         |         |         | .       |         |   |
+-----+-----+---------+---------+---------+---------+---------+---+
| 13  | O   | SnowLim |         | Maximum | RunCont | E       | P |
|     |     | Patch   |         | SWE     | rol.nml | x       | a |
|     |     |         |         | [mm]    | ]].     | a       | v |
|     |     |         |         | Limit   | +---+-- | m       | e |
|     |     |         |         | of snow | -+---+  | p       | d |
|     |     |         |         | water   | +===+== | l       | B |
...
|     |     |         |         |         |         | _       |   |
+-----+-----+---------+---------+---------+---------+---------+---+
| 14  | O   | SnowLim |         | SWE     | RunCont | E       | P |
|     |     | Remove  |         | when    | rol.nml | x       | a |
|     |     |         |         | snow is | ]].     | a       | v |
|     |     |         |         | removed | -  **Cu | m       | e |
|     |     |         |         | from    | rrently | p       | d |
|     |     |         |         | this    | not     | l       | B |
...
|     |     |         |         | ous).** |         |         |   |
+-----+-----+---------+---------+---------+---------+---------+---+
| 21  | L   | ESTMCod |         | Code    | SUEWS_E | SUEWS_S |   |
...
|     |     |             |         | Albedo Max. |           |   |
+-----+-----+-------------+---------+-------------+-----------+---+
| 3   | MU  | AlbedoMax   | 0-1     | Albedo of   | E x a m p | W |
|     |     |             |         | this        | l e v a l | a |
|     |     |             |         | surface [-] | u e s [ - | t |
|     |     |             |         | -  Effect   | ] 0 . 1   | e |
|     |     |             |         | ive albedo  |           | r |
...
|     |     |             |         | ---+        |           |   |
+-----+-----+-------------+---------+-------------+-----------+---+
| 4   | MU  | Emissivit y | 0-1     | Emissivit y | E x a m p | W |
|     |     |             |         | of this     | l e v a l | a |
|     |     |             |         | surface [-] | u e s [ - | t |
|     |     |             |         | -  Effect   | ] 0 . 9 5 | e |
|     |     |             |         | ive surfac  |           | r |
...
|     |     |             |         | ---+        |           |   |
+-----+-----+-------------+---------+-------------+-----------+---+
| 5   | MD  | StorageMi n |         | Minimum     | E x a m p | W |
|     |     |             |         | water       | l e v a l | a |
|     |     |             |         | storage     | u e s [ m | t |
|     |     |             |         | capacity of | m ] 0 . 5 | e |
|     |     |             |         | this        |           | r |
...
|     |     |             |         | eMin.       |           |   |
+-----+-----+-------------+---------+-------------+-----------+---+
| 7   | MD  | WetThresh   |         | Threshold   | E x a m p | W |
|     |     | old         |         | for a       | l e v a l | a |
|     |     |             |         | completel y | u e s [ m | t |
|     |     |             |         | wet surface | m ] 0 . 5 | e |
|     |     |             |         | [mm] -      |           | r |
|     |     |             |         | Depth of    |           |   |
|     |     |             |         | water which |           |   |
...
|     |     |             |         | 8).         |           |   |
+-----+-----+-------------+---------+-------------+-----------+---+
| 10  | MD  | DrainageE q | -999    | Drainage    |           |   |
|     |     |             |         | equation to |           |   |
|     |     |             |         | use for     |           |   |
|     |     |             |         | this        |           |   |
|     |     |             |         | surface. -  |           |   |
...
|     |     |             |         | surface     | integer   |   |
|     |     |             |         | during wet  | is        |   |
|     |     |             |         | condition s | arbitrary |   |
|     |     |             |         | in summer.  | but must  |   |
|     |     |             |         | Links to    | match     |   |
|     |     |             |         | [[#SUEWS_   | code      |   |
|     |     |             |         | OHMCoeffi   | specified |   |
|     |     |             |         | cients.tx t | in column |   |
|     |     |             |         |             | 1 of      |   |
|     |     |             |         |             | SUEWS_OHM |   |
|     |     |             |         |             | Coefficie |   |
|     |     |             |         |             | nts.txt.  |   |
...
(2014) [380]_. *In the current release SnowUse should be set to 0.*
...
Los Angeles and Vancouver (see Järvi et al. (2011) [392]_) and should be
...
OHM, the Objective Hysteresis Model (Grimmond et al. 1991) [453]_
...
+---------+----------------------+--------------+---------+---------+---------+---------+
| Option  | Storage  Heat Method | Files needed |         |         |         |         |
+=========+======================+==============+=========+=========+=========+=========+
| OHM     | 1                    | \*Coeff      | SUEWS_O |         |         |         |
|         |                      | icients      | HMCoeff |         |         |         |
|         |                      | a1, a2,      | icients |         |         |         |
...
|         |                      | file         |         |         |         |         |
+---------+----------------------+--------------+---------+---------+---------+---------+
| AnOHM   | 3                    | \*Therm      | SUEWS_N | SUEWS_V | SUEWS_W | SUEWS_S |
|         |                      | al           | onVeg.t | eg.txt] | ater.tx | now.txt |
|         |                      | propert      | xt]],   | ],[[#SU | t]]     | ]]      |
|         |                      | ies          | [[#SUEW | EWS_Wat | and     |         |
|         |                      | specifi      | S_Veg.t | er.txt  | [[#SUEW |         |
|         |                      | ed           | xt      |         | S_Snow. |         |
|         |                      | with         |         |         | txt     |         |
|         |                      | other        |         |         |         |         |
|         |                      | site         |         |         |         |         |
...
|         |                      | g.txt        |         |         |         |         |
+---------+----------------------+--------------+---------+---------+---------+---------+
| ESTM    | 4                    | \*Prope      | SUEWS_E | ESTMinp | SSss_YY |         |
|         |                      | rties        | STMCoef | ut.nml] | YY_ESTM |         |
|         |                      | of each      | ficient | ]       | _Ts_dat |         |
|         |                      | element      | s.txt]] | \*Time- | a_tt.tx |         |
|         |                      | specifi      | \*Model | series  | t]]     |         |
|         |                      | ed           | options | of      |         |         |
|         |                      | in           | specifi | surface |         |         |
|         |                      | [[#SUEW      | ed      | tempera |         |         |
|         |                      | S_ESTMC      | in      | tures   |         |         |
|         |                      | oeffici      | [[#ESTM | provide |         |         |
|         |                      | ents.tx      | input.n | d       |         |         |
|         |                      | t            | ml      | in      |         |         |
|         |                      |              |         | [[#SSss |         |         |
|         |                      |              |         | _YYYY_E |         |         |
...
|             | [[#SSss_YYYY_ESTM_Ts_                                                                              |
|             | data_tt.txt                                                                                        |
|             | directions.SSss_YYYY_ESTM_Ts_data_tt.txt]] used.-  Wall surface temperature is  different for four |
+-------------+----------------------------------------------------------------------------------------------------+
...
Main references for this part of the model: Onomura et al. (2015) [454]_
and Cleugh and Grimmond (2001) [455]_.
...
-  gamt_Km and gamq_gkgm written to two significant figures are required
   for the model performance in appropriate ranges [456]_.
